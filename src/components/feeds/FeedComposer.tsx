...
type FeedType = 'motion' | 'gallery' | 'voice' | 'family' | 'village' | 'square' | 'mycircle' | 'rooms' | 'council';
...
export const FeedComposer: React.FC<FeedComposerProps> = ({
  ...
  const feedTypes: Array<{ id: FeedType; label: string; icon: React.ElementType; limit: number }> = [
    { id: 'village', label: 'Village', icon: Users, limit: 1000 },
    ...
    { id: 'family', label: 'Family', icon: Users, limit: 2000 },
  ];
        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <style>{`
                .feed-type-scroll::-webkit-scrollbar {
              ...
              <div className="overflow-y-auto flex-1 p-4 space-y-4">
                ...
                {/* Feed Type Selector - HIDDEN SCROLLBAR */}
                <div>
                  ...
                  <div className="flex items-center gap-2 overflow-x-auto pb-2 feed-type-scroll">
                    {feedTypes.map((type) => {
