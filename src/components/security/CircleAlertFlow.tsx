  ...
  return (
    <div className={`rounded-2xl p-4 sm:p-6 ${
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-4 sm:mb-6">
        <div className={`p-2.5 sm:p-3 rounded-xl text-center ${
      ...
      {alert.status === 'pending' && (
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
          ...
          {alert.confirmations.length > 0 && (
            <div className={`w-full text-center p-4 sm:p-5 rounded-xl ${
              theme === 'dark' ? 'bg-gray-700 border border-gray-600' : 'bg-gray-100 border border-gray-200'
            }`}>
              <Loader className={`w-6 h-6 sm:w-7 sm:h-7 mx-auto mb-2 animate-spin ${
